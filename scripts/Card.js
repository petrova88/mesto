class Card {
    ...
    createCard() {
        this._photoImage = this._templateElement.querySelector('.photo__image');
        this._photoText = this._templateElement.querySelector('.photo__text');
        this._photoDeleteBtn = this._templateElement.querySelector('.photo__trash');
        this._photoLikeBtn = this._templateElement.querySelector('.photo__like');
